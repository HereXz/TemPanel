...
installTheme(){
    ...
    git clone https://github.com/HereXz/TemPanel.git
    cd TemPanel
...
installThemeQuestion(){
    while true; do
        read -p "Apakah Yakin Ingin Menginstal Tema Ini [y/n]? " yn
        case $yn in
            [Yy]* ) installTheme; break;;
            [Nn]* ) exit;;
            * ) echo "Jawab yes or no.";;
        esac
    done
}

repair(){
    bash <(curl https://raw.githubusercontent.com/HereXz/TemPanel/main/repair.sh)
}
